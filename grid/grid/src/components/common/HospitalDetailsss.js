    ...
    <div>
      ...
      <div className="p-5">
        ...
        <div className="bg-white p-7">
          ...
          <form className="grid grid-cols-1  gap-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
            {/* <FormControl fullWidth> */}
            ...
            {/* <div className="col-span-1 ">
              <Button
                ...
                component="label"
                size='large'
                sx={{ pt: 2, pb: 1.5, textAlign: 'center', width: '340px' }}
                startIcon={<FileUploadOutlinedIcon />}
              >
                Upload Hospital Logo
                <input
            ...
            <div className="sm:col-span-2 lg:col-span-3 xl:col-span-4 2xl:col-span-4">
              <Button
                fullWidth
                variant="contained"
                color="primary"
